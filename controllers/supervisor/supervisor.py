...
# (overridable via environment variables so batch trials can sweep
#  |C| and alpha without editing this file)
#############################################
...
# One Pi-puck chassis diameter: a runner is caught when a catcher gets
...
def yaw_of(node):
    ...
    # orientation is a flattened 3x3 rotation matrix; for a pure
    # rotation about the Z axis, atan2(R10, R00) recovers the yaw.
    return math.atan2(
        orientation[3],
        orientation[0]
    )
